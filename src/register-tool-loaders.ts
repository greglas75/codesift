...
export const findYii3AttributeCandidates = lazyExport<typeof import("./tools/yii3-attribute-candidates-tools.js").findYii3AttributeCandidates>(loadYii3AttributeCandidatesTools, "findYii3AttributeCandidates");

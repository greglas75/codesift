...
// Re-export AST readers for backward compatibility
export { parseMetadataExport, extractFetchCalls } from "./nextjs-metadata-readers.js";
export type { MetadataFields, FetchCall, FetchCallee } from "./nextjs-metadata-readers.js";
export { extractZodSchema, extractLinkHrefs } from "./nextjs-ast-readers.js";
export type { ZodShape, ZodFieldType, LinkRef, LinkRefKind } from "./nextjs-ast-readers.js";

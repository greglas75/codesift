...
#
# Usage:  ./scripts/telemetry-pull.sh [ssh-host]     (default: root@100.103.91.24)
...
HOST="${1:-root@100.103.91.24}"
REMOTE="${CODESIFT_COLLECTOR_REMOTE:-/opt/telemetry-collector/data/}"

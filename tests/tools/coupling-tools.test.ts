...
// This tool builds a graph over file paths and never reads a symbol, so it now takes the SUMMARY.
// Derived from the same fixture rather than stubbed separately: two stubs of one fixture drift, and
// the drift surfaces as a test asserting on the mock.
